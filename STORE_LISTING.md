...
Digital tasbih app - Counter, goals, widget, 15 languages
...
Zikirmatik, Müslümanların günlük ibadetlerini ve kişisel zikirlerini takip etmelerine yardımcı olmak için tasarlanmış sade ve erişilebilir bir dijital tesbih uygulamasıdır.
...
• Veri dışa/içe aktarma (CSV/JSON)
...
📊 GİZLİLİK
Tüm veriler cihazınızda yerel olarak saklanır. Kişisel bilgi toplamıyoruz veya iletmiyoruz.
...
**Special access needed:** None  
**Restricted content:** None  
**Ads:** Yes (AdMob banner and rewarded ads)
...
**English:**
Initial release of Zikirmatik
• Digital tasbih counter
• Multiple goals and streak tracking
• 15 language support
• Home screen widget
...
**Turkish:**
Zikirmatik ilk sürüm
• Dijital tesbih sayacı
• Çoklu hedef ve seri takibi
• 15 dil desteği
• Ana ekran widget'ı
